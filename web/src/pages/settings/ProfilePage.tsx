          ...
          <div className="bg-[#161616] border border-[#262626] rounded-xl p-5 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center justify-between border-t border-[#262626]/60 pt-3 w-full">
                <span className="text-gray-200 text-xs font-mono tracking-tight">{user?.email || '—'}</span>
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-1.5 text-xs text-gray-300 cursor-pointer hover:text-white transition-colors">
                  <svg className="h-3.5 w-3.5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.055 11H5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
          ...
          <div>
            ...
            <div className="bg-[#161616] border border-[#262626] rounded-xl overflow-hidden">
              ...
              <div className="px-4 py-3 border-b border-[#262626]/30 hover:bg-[#1f1f1f]/20 transition-colors flex items-center text-xs">
                ...
                <span className="flex-1 text-gray-300 font-mono">{user?.email || '—'}</span>
                <span className="flex-1 text-gray-500 font-mono">{account?.created_at ? new Date(account.created_at).toLocaleDateString() : '—'}</span>
              </div>
            </div>
          </div>
        </>
