# boxty.container_process

## boxty.container_process.ContainerProcess
...
Container processes communicate via direct communication with the Boxty worker where the container is running.
